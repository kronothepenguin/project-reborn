...
func handleMSG_ACCEPT_TUTOR_INVITATION(*protocol.Packet) error           { return nil }
func handleMSG_REJECT_TUTOR_INVITATION(*protocol.Packet) error           { return nil }
func handleMSG_INIT_TUTORSERVICE(*protocol.Packet) error                 { return nil }
func handleMSG_WAIT_FOR_TUTOR_INVITATIONS(*protocol.Packet) error        { return nil }
func handleMSG_CANCEL_WAIT_FOR_TUTOR_INVITATIONS(*protocol.Packet) error { return nil }
