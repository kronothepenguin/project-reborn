...
**Source**: `docs/drmx2004_scripting_ref.txt` lines 15772-15894
...
### Parameters
paramNameOrNum Required. A string that specifies the name of the parameter name to return, or
...
### Implementation
- **File**: `apps/client/src/director/api/externalParamName.js`
- **Test**: `apps/client/src/director/api/__tests__/externalParamName.test.js`
