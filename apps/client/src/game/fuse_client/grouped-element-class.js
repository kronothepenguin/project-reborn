  ...
  return {
    ...
    define(tProps) {
      ...
      if (voidp(this.pProps[Symbol.for("member")])) {
        ...
        tMemNum = _director.getmemnum(this.pProps[Symbol.for("member")]);
      }
      if ((tMemNum > 0) && (this.pType !== Symbol.for("image"))) {
        tImage = member(tMemNum);
        this.pDepth = tImage.image.depth;
        this.pimage = tImage.image.duplicate();
    ...
    resizeTo(tX, tY) {
      let tOffX = tX - this.pwidth;
      let tOffY = tY - this.pheight;
    ...
    render() {
      let tTargetRect = rect(this.pLocX, this.pLocY, this.pLocX + this.pwidth, this.pLocY + this.pheight);
      let tSourceRect = this.pimage.rect;
    ...
    draw(tRGB) {
      ...
      tTargetRect = rect(this.pLocX, this.pLocY, this.pLocX + this.pwidth, this.pLocY + this.pheight);
      this.pBuffer.image.draw(tTargetRect, { [Symbol.for("shapeType")]: Symbol.for("rect"), [Symbol.for("color")]: tRGB });
    },
  };
}
