...
export default function () {
  let tOffX, tOffY, tOffW, tOffH, tRegPnt, tImage;
  ...
  return {
    ...
    moveTo(tLocX, tLocY) {
      tOffX = tLocX - this.pLocX;
      tOffY = tLocY - this.pLocY;
    ...
    setProperty(tProp, tValue) {
      switch (tProp) {
        ...
        case Symbol.for("member"):
          switch (ilk(tValue)) {
            case Symbol.for("string"):
              this.pBuffer = _director.getMember(tValue);
              break;
        ...
        case Symbol.for("palette"):
          ...
          break;
        case Symbol.for("depth"):
          tImage = this.pBuffer.image.duplicate();
