import { call, ilk, image, list, point, rect, the, voidp, VOID } from "../../director";
  ...
  return {
    ...
    feedImage(tImage) {
      if (!(ilk(tImage) === Symbol.for("image"))) {
        return _director.error(this, "Image object expected!" + " " + tImage, Symbol.for("feedImage"), Symbol.for("minor"));
      }
      let tTargetRect = rect(this.pOwnX, this.pOwnY, this.pOwnX + this.pOwnW, this.pOwnY + this.pOwnH);
