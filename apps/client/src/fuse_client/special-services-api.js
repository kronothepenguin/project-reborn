...
function constructSpecialServices() {
  return createManager(symbol('#special_services'), getClassVariable('special.services.class'))
}
...
export function performance() {
  if (objectExists(symbol('#perf_tester'))) {
    ...
    return createObject(symbol('#perf_tester'), getClassVariable('perf.test.class'))
  }
}
